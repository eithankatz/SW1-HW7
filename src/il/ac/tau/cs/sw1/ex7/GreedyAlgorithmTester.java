...
public class GreedyAlgorithmTester {
    ...
    public static void fksTest(){
        FractionalKnapSack.Item s1 = new FractionalKnapSack.Item(10,60);	//1/6
        FractionalKnapSack.Item s2 = new FractionalKnapSack.Item(20,100);	//1/5
        FractionalKnapSack.Item s3 = new FractionalKnapSack.Item(30,120);	//1/4
